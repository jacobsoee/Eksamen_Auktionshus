...
-- --------------------------------------------------
-- Date Created: 12/08/2020 20:00:47
-- Generated from EDMX file: C:\Users\Jacob\source\repos\Eksamen_Auktionshus\Auktionshus_WPF\Model\AuktionDatabase.edmx
-- --------------------------------------------------
...
-- Creating foreign key on [SalesOffer_Id] in table 'PurchaseOffers'
ALTER TABLE [dbo].[PurchaseOffers]
ADD CONSTRAINT [FK_PurchaseOfferSalesOffer]
    FOREIGN KEY ([SalesOffer_Id])
    REFERENCES [dbo].[SalesOffers]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK_PurchaseOfferSalesOffer'
CREATE INDEX [IX_FK_PurchaseOfferSalesOffer]
